      ...
      <div className="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="space-y-1">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">
            Upload photos taken with your mobile phone to receive real-time feedback on lighting, backdrop clarity, and e-commerce appeal.
          </p>
        </div>
      </div>
            ...
            <div className="relative aspect-4/3 rounded-2xl overflow-hidden bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
              ...
              {analyzing && (
                <div className="absolute inset-0 bg-slate-900/70 backdrop-blur-xs flex flex-col items-center justify-center text-white space-y-3">
                  ...
                  <p className="text-xs font-bold">Gemini Vision AI Analyzing Lighting...</p>
                </div>
              )}
            </div>
